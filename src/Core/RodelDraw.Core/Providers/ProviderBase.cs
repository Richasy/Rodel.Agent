...
public abstract class ProviderBase
{
    ...
    /// </summary>
    protected ProviderBase(string key, List<DrawModel>? customModels = null)
    {
        AccessKey = key;
    ...
    /// 服务端模型列表.
    /// </summary>
    public List<DrawModel>? ServerModels { get; set; }
    ...
    public DrawModel GetModelOrDefault(string modelId)
    ...
    public List<DrawModel> GetModelList()
    {
        var models = new List<DrawModel>();
    ...
    internal static string GetKernelModelId(Kernel? kernel)
    {
        ...
        return drawService?.Attributes?.GetValueOrDefault(AIServiceExtensions.ModelIdKey)?.ToString() ?? default;
    }

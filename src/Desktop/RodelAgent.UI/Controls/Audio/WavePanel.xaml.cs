...
public sealed partial class WavePanel : WavePanelBase
{
    ...
    /// </summary>
    public WavePanel() => InitializeComponent();
    ...
    private bool IsDark() => this.Get<IAppToolkit>().GetCurrentTheme() == ApplicationTheme.Dark;

    private static bool IsHighContrast()
        => new AccessibilitySettings().HighContrast;

    private Color GetRectColor(bool isHighlight)
    {
...
/// 波形面板基类.
/// </summary>
public abstract class WavePanelBase : LayoutUserControlBase<AudioWaveViewModel>
{
    protected WavePanelBase() => ViewModel = this.Get<AudioWaveViewModel>();
}